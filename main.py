...
def main():
    ...
    # second_half_price = products.SecondHalfPrice(product_list)
    # third_one_free = products.ThirdOneFree(product_list)
    # thirty_percent = products.PercentDiscount(product_list)
